...
object AiPromptFactory {
    ...
    fun buildSystemPrompt(
        ...
        sb.appendLine("Automatically detect if a task is a habit or an event and set the respective parameters (is_habit, is_event, event_icon, event_color, recurrence_interval, recurrence_days):")
